...
class CaseStudy
{
     ...
     * @var string
     *
     * @ORM\Column(name="investigation_lines", type="text")
     */
     ...
     * @var string
     *
     * @ORM\Column(name="research_group", type="text")
     */
     ...
     * @var string
     *
     * @ORM\Column(name="related_institution", type="text")
     */
     ...
     * @var string
     *
     * @ORM\Column(name="contact_info", type="text")
     */
    private $contactInfo;
